...
def render_textrect(text, font=None, rect=None,
                    color=(255,0,0), bgcolor=(0,0,0), justification=0):
    """Returns a surface containing the passed text text, reformatted
    to fit within the given rect, word-wrapping as necessary. The text
    will be anti-aliased.

    Takes the following arguments:

    text - the text you wish to render. \n begins a new line.
    font - a Font object
    rect - a rectstyle giving the size of the surface requested.
    color - a three-byte tuple of the rgb value of the
